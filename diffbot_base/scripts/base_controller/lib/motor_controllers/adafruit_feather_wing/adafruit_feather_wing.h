...
/** \brief AdafruitMotorController implementation of the MotorControllerIntf
 * 
...
{
    public:
        /** \brief Construct an AdafruitMotorController for a single motor
         * 
         * Specify the motor to control \code motor_num (use 3 or 4 for diffbot).
